...
export function IndustrialIndexScreen({ go }) {
  return (
    <main className="screen id active" id="s-id-index">
      <header className="id-open"><h1>Industrial design.</h1><p className="blurb">Three product concepts explored through sketches, physical models, CAD, and material studies. From hearing support to the kitchen counter and the front door.</p></header>
